...
namespace Senparc.NeuChar.App.AppStore
{
    public static class AppStoreOAuth
    {
        ...
        /// <returns></returns>
        public static async Task<OAuthAccessTokenResult> GetAccessTokenAsync(string clientId, string clientSecret, string code, string grantType = "authorization_code")
        {
